...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    /****
     * This JSON -> JS conversion is rather ugly..
     * Unfortunatly I hate grunt and all that crap but it is "required" today :(
     * TODO: simplify the config (no reduncant file lists)
     * TODO: make it work in devel/serve mode without that hack.
     */
    json: {
      main: {
		    options: {
